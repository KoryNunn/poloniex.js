module.exports = (function() {
    ...
    returnCompleteBalances: function(callback) {
        ...
        buy: function(currencyA, currencyB, rate, amount, settings, callback) {
        ...
        sell: function(currencyA, currencyB, rate, amount, settings, callback) {
            if(typeof settings === 'function'){
                callback = settings;
                settings = {};
            }
        ...
        moveOrder: function(orderNumber, rate, amount, settings, callback) {
            if(typeof settings === 'function'){
                callback = settings;
                settings = {};
            }
